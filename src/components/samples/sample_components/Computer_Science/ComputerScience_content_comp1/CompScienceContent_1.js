            ...
            <div className="row justify-content-center">
                <div className="col-md-10">
                    <div className="section-heading text-center mb-5">
                        ...
                        <h2>Report onComputing and Computing Technologies</h2>
                        <hr></hr>
...
export default CompScienceContent_1;
