...
export default function HeroSection() {
  return (
    <>
      <section className="ptb-70 " style={{backgroundImage: 'url(img/assssdddf.png)',backgroundPosition:'cover',backgroundRepeat:'no-repeat',backgroundSize:'cover'}}>
        <div className="container">
            <div className="row align-items-center">
                <div className="col-md-12 col-lg-5">
                    <div className="hero-slider-content text-white pt-5">
                        
                        <h1 className="text-white">The Assigment Writing</h1>
                        ...
                        <div className="action-btns mt-3">
                          <button href="#" className=" secondary-solid-btn">Start Now</button>   
                        </div>
                    </div>
                </div>
