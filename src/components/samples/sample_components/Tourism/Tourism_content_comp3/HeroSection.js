...
export default function HeroSection() {
  return (
    <>
      ...
      <section className="ptb-100" style={{backgroundImage: 'url(img/photo-open-book.jpg)',backgroundPosition:'cover',backgroundRepeat:'no-repeat',backgroundSize:'cover',backgroundPosition:'fixed'}}>
